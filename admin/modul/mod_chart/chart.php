			...
			<div class="box span12">
				...
				-->
					<table class="table table-striped table-bordered bootstrap-datatable datatable">
						...
						<tbody>
	';
							$tampil = mysql_query("select * from orders WHERE status_order != 'Selesai' ORDER BY id_orders DESC");
							$no = 1;
  ...
  case "detailchart":
   $edit = mysql_query("SELECT * FROM orders WHERE id_orders='$_GET[id]'");
    ...
    elseif ($r[status_order]=='Baru Dibayar'){
        $pilihan_status = array('Pengiriman', 'Baru Dibayar', 'Selesai');    
    }
						...
						<fieldset>						
							...
							<table class="table">
								...
								<tr>
									<td>Status Order</td> 
									<td> 
										<select id="selectError" data-rel="chosen" name="status" value="'.$pilihan_order.'">'.$pilihan_order.'</select> 
